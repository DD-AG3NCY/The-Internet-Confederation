...
import { AgreementIcon, DropdownIcon, InfoIcon } from "../../icons";
import { Body3 } from "../atoms";
import { Handler } from "../molecules";
...
const NavBar = ({}: NavBarProps) => {
	return (
		<nav id="navigation" className="flex items-center justify-center gap-4">
			<InfoIcon className="w-12 h-12 fill-primary-neutral rounded-full transition-all" />
			<div className="flex bg-primary-neutral-200 rounded">
				{/* <Link href="/agreements"> */}
				<Handler
					primaryIcon={AgreementIcon}
